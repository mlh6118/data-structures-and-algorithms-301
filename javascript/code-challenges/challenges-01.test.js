...
// Declare a function called "addOne" and pass it an array.
const addOne = (arr) => {

  // Declare a new local array.
  let localArr = [];

  // Loop through each element of the array passed in.
  arr.forEach(element => {
    // Add one to each element, then push it to the local array.
